  ...
  return (
    <div>
      <div style={{ padding:'32px 36px', maxWidth:1400, margin:'0 auto' }}>
        <PageHeader
          title="EBO Customers (Offline)"
          subtitle="Customers who purchased only at EBO stores — never ordered online"
          action={
        ...
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:20, marginBottom:20 }}>
          ...
          <div className="card" style={{ padding:24 }}>
            <div style={{ fontSize:14, fontWeight:600, marginBottom:4 }}>EBO AOV — New vs Repeat{month ? ` · ${monthLabel}` : ''}</div>
            <div style={{ fontSize:12, color:'var(--text-muted)', marginBottom:16 }}>
              Average in-store bill value by customer type
            </div>
          ...
          <div className="card" style={{ padding:24 }}>
            ...
            <div style={{ fontSize:12, color:'var(--text-muted)', marginBottom:16 }}>
              How many times EBO customers have visited stores
            </div>
            {loading ? <CardSkeleton rows={4}/> : (
              <ResponsiveContainer width="100%" height={200}>
                <BarChart data={freq} layout="vertical">
                  ...
                  <Bar dataKey="customers" name="Customers" fill="var(--amber)" radius={[0,4,4,0]}>
